        ...
        <div class="container">
          <div class="row gy-4 gy-lg-0 align-items-lg-center">
            <div class="col-12 col-lg-6">
              <img class="img-fluid rounded border border-dark" loading="lazy" src="https://png.pngtree.com/png-clipart/20250101/original/pngtree-a-collection-of-sports-equipment-including-cricket-player-png-image_18458144.png" alt="About Us" />
            </div>
